...
set cbrange[0:3.6]
splot "${filefe}" with pm3d, "points_m${mode}.dat" with points linecolor rgb "white"
set size .5,.5
set origin 0.5,0.15
set xrange[1.5:5.0]
set yrange[1.5:5.0]
